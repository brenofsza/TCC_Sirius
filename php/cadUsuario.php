...
if ($stmt->execute()) {
    ...
    // pega o ID do usuario que acabou de ser cadastrado

    $id_usuario = $stmt->insert_id;


    // cria a pasta Favoritos para o usuario

    $sqlPasta = "INSERT INTO PASTA(COD_USU, NOME_PASTA) VALUES (?, 'Favoritos')";

    $stmtPasta = $conexao->prepare($sqlPasta);

    $stmtPasta->bind_param("i", $id_usuario);
